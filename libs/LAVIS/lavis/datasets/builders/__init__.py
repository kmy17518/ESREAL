...
from lavis.datasets.datasets.image_paragraph_datasets import ImageParagraphDataset
...
def load_dataset(name, cfg_path=None, vis_path=None, data_type=None, df_path=None, image_dir=None, include_pil=True):
    """
    Example
    ...
    if name == "image_paragraph":
        assert df_path is not None and image_dir is not None
        datasets = {
            "train": ImageParagraphDataset(df_path, image_dir, split="train", include_pil=include_pil),
            "val": ImageParagraphDataset(df_path, image_dir, split="val", include_pil=include_pil),
            "test": ImageParagraphDataset(df_path, image_dir, split="test", include_pil=include_pil),
        }
        return datasets
