...
class NNModelConfig:
    ...
    :param ref_to_model: Reference to initialized model
    """

    model_arch_type: str = "causal"
    ref_to_model: Union[Type[nn.Module], nn.Module] = None
    model_copy: nn.Module = None
...
class TRLConfig:
    ...
    method: MethodConfig
    model: Union[ModelConfig, NNModelConfig]
